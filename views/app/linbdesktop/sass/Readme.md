...
folder are mapped to the application's root namespace, 'linbdesktop'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "linbdesktop"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'linbdesktop' in the same way
as `"linbdesktop/sass/src"`.
