Ext.define("touchapp.Demo.controller.Users", {
  ...
  getList: function() {
    return Ext.getCmp("user-grid");
  },

  getTop: function() {
    return Ext.getCmp("user-top");
  },
                        ...
                        Ext.Ajax.request({
                          ...
                          success: function(res, opts) {
                            ...
                            if (data.success) {
                              ...
                              Ext.MessageBox.alert('上传错误', JSON.stringify(data.data));
                            }
                          }, failure: function(res, opts) {
                            Ext.MessageBox.alert('上传错误', res.responseText); 
                          }
                        })
  ...
  exportUser: function() {
    ...
    var store = Ext.create("touchapp.Demo.store.Users");
  ...
  createOrUpdateUser: function(button) {
    ...
    var user = Ext.create('touchapp.Demo.model.Users', values);
